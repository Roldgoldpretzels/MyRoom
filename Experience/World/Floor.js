...
export default class Floor {
    ...
    setCircles() {
        ...
        const material = new THREE.MeshStandardMaterial({ color:  0x74b5bd });
        const material2 = new THREE.MeshStandardMaterial({ color: 0x7491BD});
        const material3 = new THREE.MeshStandardMaterial({ color:  0x655e8a});
